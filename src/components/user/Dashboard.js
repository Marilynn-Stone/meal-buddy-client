...
export default function Dashboard() {
  ...
  return (
    <section className="sign-up">
      <div className="App">
        <div>
          <h1 className="sign-up-title">Settings</h1>
          <section className="sign-up-info">
            ...
            >
              ...
              <section className="dietary-options">
                ...
                ></input>
                <label className="signup-label"><br />Dietary Category</label>
                <select
                ...
                <br />
                <label className="signup-label"><br />Dietary Restrictions</label>
